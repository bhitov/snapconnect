...
const mockData = {
  BALANCED_ROMANTIC: {
    data: {
      ...
      username: 'alexj',
      coachMessages: [
        { id: 'c1', senderId: 'coach', text: "Hi! I'm your relationship coach. Ask me anything or choose an option from the menu.", createdAt: Date.now() - 50000, conversationId: 'coach-123' },
        { id: 'c2', senderId: 'test-user-1', text: "I'd like some help understanding our communication patterns", createdAt: Date.now() - 45000, conversationId: 'coach-123' },
        { id: 'c3', senderId: 'coach', text: "I'd be happy to help analyze your communication patterns. Based on Dr. Gottman's research, healthy relationships maintain a 5:1 ratio of positive to negative interactions. Let me analyze your recent conversations.", createdAt: Date.now() - 40000, conversationId: 'coach-123' },
        { id: 'c4', senderId: 'test-user-1', text: "That sounds helpful. Sometimes I feel like we're doing well but other times we struggle", createdAt: Date.now() - 35000, conversationId: 'coach-123' },
        { id: 'c5', senderId: 'coach', text: "That's completely normal. All relationships have ups and downs. What matters is how you handle conflicts and maintain connection. Would you like me to analyze your recent conversations or discuss specific challenges?", createdAt: Date.now() - 30000, conversationId: 'coach-123' }
      ] as TextMessage[],
      parentMessages: [
  ...
  HIGH_CONFLICT_ROMANTIC: {
    data: {
      ...
      username: 'tbrown',
      coachMessages: [
        { id: 'c1', senderId: 'coach', text: "Hi! I'm your relationship coach. Ask me anything or choose an option from the menu.", createdAt: Date.now() - 50000, conversationId: 'coach-345' },
        { id: 'c2', senderId: 'test-user-3', text: "We keep having the same fights over and over", createdAt: Date.now() - 45000, conversationId: 'coach-345' },
        { id: 'c3', senderId: 'coach', text: "I hear how frustrating that must be. Repetitive conflicts often indicate deeper unresolved issues. Dr. Gottman's research shows that 69% of relationship problems are perpetual. The key is learning to manage them constructively.", createdAt: Date.now() - 40000, conversationId: 'coach-345' },
        { id: 'c4', senderId: 'test-user-3', text: "It feels hopeless sometimes. We just end up hurting each other", createdAt: Date.now() - 35000, conversationId: 'coach-345' },
        { id: 'c5', senderId: 'coach', text: "Your feelings are valid, and it takes courage to seek help. When couples hurt each other repeatedly, it's often due to what Gottman calls the 'Four Horsemen' - criticism, contempt, defensiveness, and stonewalling. Let's work on replacing these with healthier patterns.", createdAt: Date.now() - 30000, conversationId: 'coach-345' }
      ] as TextMessage[],
      parentMessages: [
