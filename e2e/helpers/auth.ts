...
export async function signupAndSkipProfile(page: Page, userPrefix: string = 'user') {
  ...
  await page.getByTestId('complete-setup-button').waitFor({ state: 'visible', timeout: 500 });
