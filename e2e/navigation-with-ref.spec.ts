...
import {
  NavigationHelper,
  injectNavigationHelpers,
} from './helpers/navigation';

test.describe('Navigation with Reference Tests', () => {
  test('navigation state tracking using navigationRef directly', async ({
    page,
  }) => {
    ...
    await page.screenshot({
      path: 'test-results/navigation-with-ref-final.png',
    });
  ...
  test('navigation state polling and verification', async ({ page }) => {
    ...
    await page.screenshot({
      path: 'test-results/navigation-polling-camera.png',
    });
    ...
    await page.screenshot({
      path: 'test-results/navigation-polling-stories.png',
    });
  });
  ...
  test('error handling with navigation ref access', async ({ page }) => {
    ...
    // Final screenshot
    await page.screenshot({
      path: 'test-results/navigation-error-handling-final.png',
    });
  });
});
